...
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = '{WASTING_STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_sam_treatment_{SAM_TREATMENT_STATE}_mam_treatment_{MAM_TREATMENT_STATE}_sq_lns_{SQLNS_STATE}_x_factor_{X_FACTOR_STATE}_maternal_supplementation_{MATERNAL_SUPPLEMENTATION_TYPES}_itn_{ITN_STATE}_diarrhea_{DIARRHEA_STATE}'
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = '{WASTING_TRANSITION}_event_count_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_sam_treatment_{SAM_TREATMENT_STATE}_mam_treatment_{MAM_TREATMENT_STATE}_sq_lns_{SQLNS_STATE}_x_factor_{X_FACTOR_STATE}_maternal_supplementation_{MATERNAL_SUPPLEMENTATION_TYPES}_itn_{ITN_STATE}_diarrhea_{DIARRHEA_STATE}'
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = '{STUNTING_STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_sq_lns_{SQLNS_STATE}_maternal_supplementation_{MATERNAL_SUPPLEMENTATION_TYPES}_itn_{ITN_STATE}'
