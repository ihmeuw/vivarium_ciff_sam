...
BIRTHS_COLUMN_TEMPLATE = '{BIRTH_METRIC}_in_{YEAR}_among_{SEX}_maternal_malnutrition_{MATERNAL_MALNUTRITION_STATE}_maternal_supplementation_{MATERNAL_SUPPLEMENTATION_TYPES}_itn_{ITN_STATES}'
