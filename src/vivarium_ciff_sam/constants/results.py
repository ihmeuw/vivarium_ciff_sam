...
DIARRHEAL_DISEASES_STATE_PERSON_TIME_COLUMN_TEMPLATE = '{DIARRHEAL_DISEASES_STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_therapeutic_zinc_{THERAPEUTIC_ZINC_STATE}_preventative_zinc_{PREVENTATIVE_ZINC_STATE}'
DIARRHEAL_DISEASES_TRANSITION_COUNT_COLUMN_TEMPLATE = '{DIARRHEAL_DISEASES_TRANSITION}_event_count_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_therapeutic_zinc_{THERAPEUTIC_ZINC_STATE}_preventative_zinc_{PREVENTATIVE_ZINC_STATE}'
