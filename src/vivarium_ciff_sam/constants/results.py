...
DISEASE_STATE_PERSON_TIME_COLUMN_TEMPLATE = '{NON_DIARRHEA_DISEASE_STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_wasting_state_{WASTING_STATE}'
DISEASE_TRANSITION_COUNT_COLUMN_TEMPLATE = '{NON_DIARRHEA_DISEASE_TRANSITION}_event_count_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_wasting_state_{WASTING_STATE}'
