...
class Mortality(_Mortality):
    ...
    def __init__(self):
        ...
        self.all_cause_mortality_hazard_paf_pipeline_name = 'all_causes.mortality_hazard.population_attributable_fraction'
    ...
    def _get_raw_unmodeled_csmr(self, builder: Builder) -> LookupTable:
        ...
        for idx, cause in enumerate(data_keys.UNMODELED_CAUSES):
            if 0 == idx:
