...
class LBWSGRisk(Risk, ABC):
    ...
    @classmethod
    def get_category_intervals(cls, builder: Builder) -> pd.Series:
...
class LBWSGRiskEffect(RiskEffect):
    ...
    def setup(self, builder: Builder) -> None:
        ...
        self.early_neonatal_interval, self.late_neonatal_interval = self.get_age_intervals(builder)
    ...
    @staticmethod
    def get_age_intervals(builder: Builder) -> Tuple[pd.Interval, pd.Interval]:
